...
# (Updated Hugging Face endpoints + same logic)
...
# ✅ UPDATED Hugging Face API URLs (old one deprecated)
API_URLS = {
    "topics": "https://router.huggingface.co/hf-inference/models/facebook/bart-large-mnli",
    "summary": "https://router.huggingface.co/hf-inference/models/sshleifer/distilbart-cnn-6-6",
    "sentiment": "https://router.huggingface.co/hf-inference/models/distilbert/distilbert-base-uncased-finetuned-sst-2-english",
    "audio": "https://router.huggingface.co/hf-inference/models/openai/whisper-large-v3"
}

def make_api_call(api_url, data, is_json=True):
    """Handles all API calls, including the 503 'model loading' retry logic."""
    if not HF_TOKEN:
